...
if __name__ == "__main__":
    ...
    parser.add_argument("--finput", type=str, default="data/rebel_sub_4omini_context/test_instructions_context_llama2_7b_itr1.csv")
    parser.add_argument("--foutput", type=str, default="data/rebel_sub_4omini_context/pred_instructions_context_naive_llama2_7b_itr1.csv")
